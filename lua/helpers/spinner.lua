---@class CodeCompanionProcessor
---@field processing boolean Flag indicating if processing is active
---@field spinner_index integer Current index in the spinner array
---@field namespace_id integer|nil Namespace ID for highlighting
---@field timer uv_timer_t|nil Timer for animation
---@field spinner_symbols string[] Array of spinner animation characters
---@field filetype string Filetype identifier for CodeCompanion buffers
local M = {
  processing = false,
  spinner_index = 1,
  namespace_id = nil,
...
---Gets a buffer with the specified filetype
---@param filetype string The filetype to search for
---@return integer|nil The buffer handle if found, nil otherwise
...
---@param self table The spinner object
---@return nil
