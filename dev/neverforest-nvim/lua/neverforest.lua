local util = require("neverforest.util")
local colours = require("neverforest.colours")
local highlights = require("neverforest.highlights")
...
local palette = colours.generate_palette(M.config, vim.o.background)
M.colorscheme = highlights.generate_syntax(palette, M.config)
