...
highlights.generate_syntax = function(palette, options)
  ...
  local syntax = {
    ...
    Folded = syntax_entry(palette.none, colour_respecting_options(palette.bg3)),
    SignColumn = syntax_entry(palette.fg, palette.none),
    FoldColumn = syntax_entry(palette.fg, palette.none),
    ...
    StatusLine = syntax_entry(palette.bg1, palette.none),
    StatusLineNC = syntax_entry(palette.fg, palette.none),
    ...
    TabLineFill = syntax_entry(palette.fg, palette.bg_dim),
    TabLineSel = syntax_entry(palette.bg0, palette.statusline1),
    VertSplit = syntax_entry(palette.fg, palette.none),
    ...
    RedSign = syntax_entry(palette.red, palette.none),
    OrangeSign = syntax_entry(palette.orange, palette.none),
    YellowSign = syntax_entry(palette.yellow, palette.none),
    GreenSign = syntax_entry(palette.green, palette.none),
    AquaSign = syntax_entry(palette.aqua, palette.none),
    BlueSign = syntax_entry(palette.blue, palette.none),
    PurpleSign = syntax_entry(palette.purple, palette.none),
    -- Configuration based on `diagnostic_text_highlight` option
    ErrorText = syntax_entry(palette.red, palette.none, { styles.undercurl }, palette.red),
    WarningText = syntax_entry(palette.yellow, palette.none, { styles.undercurl }, palette.yellow),
    InfoText = syntax_entry(palette.blue, palette.none, { styles.undercurl }, palette.blue),
    HintText = syntax_entry(palette.green, palette.none, { styles.undercurl }, palette.green),
    ...
    -- hrsh7th/nvim-cmp
    CmpItemAbbrMatch = syntax_entry(palette.aqua, palette.none, { styles.bold }),
    ...
    CmpItemKindCopilot = { link = "Green" },
    -- folke/trouble.nvim
    TroubleText = { link = "Fg" },
    TroubleSource = { link = "Grey" },
    TroubleCode = { link = "Grey" },
    -- nvim-telescope/telescope.nvim
    TelescopeNormal = { link = "ColorColumn" },
    TelescopePromptTitle = syntax_entry(palette.bg1, palette.red),
    TelescopePreviewTitle = syntax_entry(palette.bg1, palette.green),
    TelescopePreviewNormal = syntax_entry(palette.fg, palette.bg_dim),
    TelescopePreviewBorder = syntax_entry(palette.bg_dim, "#2b3136"),
    TelescopeMatching = syntax_entry(palette.green, palette.none, { styles.bold }),
    TelescopeBorder = { link = "ColorColumn" },
    TelescopePromptNormal = syntax_entry(palette.fg, palette.bg2),
    TelescopePromptCounter = { link = "TelescopePromptNormal" },
    TelescopePromptBorder = syntax_entry(palette.bg2, "#2b3136"),
    TelescopeResultsBorder = syntax_entry(palette.bg1, "#2b3136"),
    TelescopeResultsTitle = syntax_entry(palette.bg1, palette.purple),
    TelescopePromptPrefix = { link = "Orange" },
    TelescopeSelection = { link = "DiffAdd" },

    HarpoonWindow = { link = "TelescopePreviewNormal" },
    HarpoonBorder = syntax_entry(palette.fg, palette.bg_dim),
    ...
    IndentBlanklineContextChar = syntax_entry(palette.orange, palette.none, { styles.nocombine }),
    ...
    NavicText = syntax_entry(palette.grey1, palette.none),
    NavicSeparator = syntax_entry(palette.grey1, palette.none),

    UfoCursorFoldedLine = syntax_entry(palette.none, palette.bg4),
    ...
    -- Bodies
    NotifyDEBUGBody = syntax_entry(palette.bg0, palette.grey0),
    NotifyERRORBody = syntax_entry(palette.bg0, palette.red),
    NotifyINFOBody = syntax_entry(palette.bg0, palette.green),
    NotifyTRACEBody = syntax_entry(palette.bg0, palette.purple),
    NotifyWARNBody = syntax_entry(palette.bg0, palette.yellow),
    ...
    -- b0o/incline.nvim
    InclineNormal = syntax_entry(palette.fg, palette.none),
    InclineNormalNC = syntax_entry(palette.grey1, palette.none),
    ...
    NeoTreeGitUntracked = { link = "Orange" },
    ...
    NeoTreeRootName = { link = "Fg" },
    NeoTreeFloatBorder = { link = "TelescopePreviewBorder" },
    NeoTreeFloatNormal = { link = "TelescopePreviewNormal" },
    NeoTreeFloatTitle = { link = "TelescopePromptTitle" },
    NeoTreeTitleBar = { link = "TelescopePreviewTitle" },
    NeoTreeModified = { link = "Red" },
    NeoTreeFileNameOpened = syntax_entry(palette.none, palette.none, { styles.underline, styles.italic }),
    -- edgy
    EdgyTitle = syntax_entry(palette.fg, palette.none),
    ...
    NoiceCmdlinePopup = { link = "TelescopePromptNormal" },
    NoiceCmdlinePopupTitle = { link = "TelescopePromptTitle" },
    NoiceCmdlinePopupBorder = syntax_entry(palette.bg2, palette.bg0),
  ...
  if options.transparent_background_level == 0 then
    ...
    syntax["NeoTreeNormal"] = syntax_entry(palette.fg, palette.bg0)
    syntax["NeoTreeEndOfBuffer"] = syntax_entry(palette.bg_dim, palette.bg0)
